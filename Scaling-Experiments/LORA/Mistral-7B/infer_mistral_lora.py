#!/usr/bin/env python3
"""Run TutorMind inference with a Mistral-7B LoRA adapter.

Purpose
-------
Load a task-specific Mistral-7B LoRA adapter and produce evaluator-compatible
prediction CSVs for MI, ML, PG, Act, or MT.

Input
-----
- A task-specific adapter directory created by ``train_mistral_lora.py``.
...
Example
-------
    python '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/Scaling Experiments/LORA/Mistral-7B/infer_mistral_lora.py' \\
      --task MT \\
      --adapter-path '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/Scaling Experiments/LORA/Mistral-7B/adapters/MT' \\
      --input-jsonl '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/data/val/multitask_val.jsonl' \\
      --predictions-out '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/Scaling Experiments/LORA/Mistral-7B/predictions/run_020_mt_predictions.csv'
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Run TutorMind inference with a Mistral-7B LoRA adapter."
    )
