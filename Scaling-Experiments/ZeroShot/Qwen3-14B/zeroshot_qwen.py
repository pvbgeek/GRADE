#!/usr/bin/env python3
"""Zero-shot Qwen3-14B inference for TutorMind.

Purpose
-------
Render TutorMind chat examples with the zero-shot Qwen3-14B prompts and
write evaluator-compatible prediction CSVs for MI, ML, PG, Act, or MT.
Runs with Qwen3 thinking mode OFF; includes one retry pass for Unknowns.
...
Example
-------
    python '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/Scaling-Experiments/ZeroShot/Qwen3-14B/zeroshot_qwen.py' \\
      --task MI \\
      --input-jsonl '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/data/val/mistake_identification_val.jsonl' \\
      --predictions-out '/WAVE/projects/CSEN-346-Sp26/Group3/TutorMind/Scaling-Experiments/ZeroShot/Qwen3-14B/predictions/run_021_mi_predictions.csv'
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run zero-shot TutorMind inference with the hardcoded Qwen3-14B base model."
    )
...
def main() -> None:
    ...
    with track_emissions(f"scaling-qwen14b-zeroshot-{args.task.lower()}"):
